...
const CoursesPage: React.FC<CoursesPageProps> = ({ onNavigate }) => {
  ...
  const filtered = useMemo(() => {
    ...
    if (selectedLv !== "Tất cả")
      list = list.filter((c) => c.level === selectedLv);
  ...
  const hasFilters =
    search || selectedCat || selectedLv !== "Tất cả" || selectedPrice !== "all";
      ...
      <div className="courses-header">
        <div className="container">
          ...
          <p className="courses-header__sub">
            {MOCK_COURSES.length} khóa học · từ A1 đến C2 · mọi kỹ năng tiếng
            Anh
          </p>
          ...
          <div className="courses-search">
            <svg
              className="courses-search__icon"
              width="16"
              height="16"
              viewBox="0 0 16 16"
              fill="none"
            ...
            <input
              ...
              type="search"
              placeholder="Tìm theo tên khóa học, kỹ năng, từ khoá..."
              value={search}
        ...
        <div className="courses-main">
          ...
          <div className="courses-toolbar">
            <p className="courses-toolbar__count">
              ...
              {hasFilters && (
                <span className="courses-toolbar__filtered"> (đang lọc)</span>
              )}
            </p>
